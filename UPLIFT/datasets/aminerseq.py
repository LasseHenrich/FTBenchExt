...
def writeCSV(tokenlist):
    with open('AminerAbstractSequence.csv', 'a') as out:
...
#os.remove("AminerAbstractSequence.csv")
t1 = time.time()
readNprep()
print("Elapsed time for Aminar dataset prep for T11 = %s sec" % (time.time() - t1))
